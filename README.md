...
```bash
$ whoami
> midanka lahon — B.Tech CSE | Backend Engineer | DevOps
...
```log
[2025-09] → [2026-04]  HDFC Job Ready Programme (Jillingini)
           role        : DevOps & Backend Intern
           highlights  : Git branch management strategies
...
```diff
+ [ACTIVE]   mastering system design
+ [ACTIVE]   strengthening software engineering fundamentals
